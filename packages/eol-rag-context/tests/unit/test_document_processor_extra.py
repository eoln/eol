...
"""
        ...
        # Mock AST parsing
        with patch.object(processor, '_chunk_code_by_ast') as mock_ast:
            mock_ast.return_value = [
                {"content": "def function_one", "type": "function", "metadata": {"function": "function_one"}},
                {"content": "def function_two", "type": "function", "metadata": {"function": "function_two"}}
            ]
