...
# Mock networkx with proper __spec__ for Python 3.13 (may be needed by dependencies)
nx_mock = MagicMock()
...
class TestSentenceTransformerProvider:
    ...
    async def test_single_text_to_list_conversion(self):
        ...
        config = EmbeddingConfig(
            provider="sentence-transformers", model_name="test-model", dimension=32
        )
...
class TestEmbeddingManagerAdvanced:
    ...
    def config_with_cache(self):
        ...
        return EmbeddingConfig(provider="sentence-transformers", dimension=128)
