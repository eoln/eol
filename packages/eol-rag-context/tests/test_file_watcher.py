...
class TestFileWatcher:
    ...
    def mock_indexer(self):
        ...
        indexer.scanner.scan_folder = AsyncMock(return_value=[Path("/test/file1.py"), Path("/test/file2.md")])
    ...
    @pytest.mark.asyncio
    async def test_watch_directory_with_graph_builder(self, file_watcher_with_graph, mock_graph_builder):
