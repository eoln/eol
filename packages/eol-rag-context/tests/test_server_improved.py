...
for module in ['redis', 'redis.asyncio', 'redis.commands', 'redis.commands.search',
               ...
               'redis.commands.search.query', 'redis.exceptions', 'networkx',
               'fastmcp', 'fastmcp.server', 'aiofiles', 'watchdog', 'watchdog.observers',
               'watchdog.events', 'pypdf', 'docx', 'magic', 'tree_sitter', 'yaml',
               'bs4', 'markdown', 'sentence_transformers', 'openai', 'gitignore_parser']:
