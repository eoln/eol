...
class TestProcessedDocument:
    ...
    def test_processed_document_creation(self):
        ...
        chunks = [
            {"content": "First chunk", "type": "header", "metadata": {"header": "Introduction"}},
    ...
    def test_processed_document_code(self):
        ...
        doc = ProcessedDocument(
            ...
            chunks=[{"content": "def hello(): print('world')", "type": "function", "metadata": {"function": "hello"}}],
            language="python"
        )
...
class TestDocumentProcessorAdvanced:
    ...
    @pytest.mark.asyncio
    async def test_file_type_detection_through_processing(self, processor_with_custom_config, temp_dir):
...
class MyClass:
    ...
    @pytest.mark.asyncio
    async def test_process_file_with_special_characters(self, processor_with_custom_config, temp_dir):
