...
mock_modules = [
    'magic', 'pypdf', 'docx', 'redis', 'redis.asyncio', 
    'redis.commands', 'redis.commands.search', 'redis.commands.search.field',
...
from eol.rag_context.knowledge_graph import KnowledgeGraphBuilder, Entity, EntityType, Relationship, RelationType
